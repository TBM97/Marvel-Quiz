...
// Questions based on: BuzzFeed "Ultimate Marvel Movie Triva Quiz": https://www.buzzfeed.com/kristenharris1/ultimate-marvel-movie-trivia-quiz
let quizArray = [
  {
    question:
      "What's the first piece of clothing Yelena Bolova ever bought for herself?",
    options: ["Vest", "Jacket", "White Suit", "Boots" ],
    correct: 0,
    image: "./images/Yelena.png",
  },
  {
  ...
  {
    question: "Which of these characters is NOT part of Thanos's family?",
    options: [
      "Vision",
      "Nebula",
      "Gamora",
  ...
  {
    question:
      "What job did Kingo take on after the Eternals disbanded?",
    options: [
      "Bollywood Star",
      "Hollywood Actor",
      "Cult Leader",
  ...
  },
  {
    ...
    options: [ "F.R.I.D.A.Y", "S.H.I.E.L.D.", "U.L.T.R.O.N.", "E.D.I.T.H."],
    correct: 0,
    image: "./images/Jarvis.png",
  },
  {
    question: "Who can lift Thor's hammer?",
    options: ["Captain America", "Spiderman", "Black Widow", "Iron Man"],
    correct: 0,
    image: "./images/Hammer.png",
  },
  {
    question:
      "What kind of food does Kate Bishop feed the stray dog she adopted?",
    options: ["Pizza", "Kibble", "Peas", "Chicken"],
    correct: 0,
  ...
  },
  {
    ...
    options: [ "Frost Giant", "Human", "Asgardian", "A God"],
    correct: 0,
